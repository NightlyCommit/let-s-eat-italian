...
namespace Drupal\Tests\lei\Functional;

use Drupal\Tests\BrowserTestBase;

/**
 * Tests LEI installation profile expectations.
 *
 * @group lei
 */
class LEITest extends BrowserTestBase {

  protected $profile = 'lei';
  ...
  public function testMinimal() {
    ...
    $this->assertEquals(USER_REGISTER_VISITORS_ADMINISTRATIVE_APPROVAL, $this->config('user.settings')
      ->get('register'));
  }
}
