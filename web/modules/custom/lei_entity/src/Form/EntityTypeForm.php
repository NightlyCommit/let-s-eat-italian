...
class EntityTypeForm extends ConfigFormBase
{
  ...
  /**
   * @var BundleTranslationSettingsInterface
   */
  protected $contentTranslationManager;

  public function __construct(ConfigFactoryInterface $config_factory, EntityTypeManagerInterface $entity_type_manager, ModuleHandlerInterface $module_handler, EntityFieldManagerInterface $entity_field_manager, BundleTranslationSettingsInterface $content_translation_manager)
  {
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $entity_type_id = NULL)
  {
    ...
    if ($this->moduleHandler->moduleExists('language')) {
      ...
      $form['language']['untranslatable_fields_hide'] = [
        '#type' => 'checkbox',
  ...
  public function save(array $form, FormStateInterface $form_state)
  {
    ...
    $this->configFactory()->getEditable($entity_type_id . '.settings')
      ->set('use_admin_theme', $form_state->getValue('use_admin_theme'))
      ->save();

    $this->contentTranslationManager->setBundleTranslationSettings($entity_type_id, $entity_type_id, [
      'untranslatable_fields_hide' => $form_state->getValue('untranslatable_fields_hide')
    ]);
  }
