 ...
 *   handlers = {
 *     "storage" = "Drupal\lei_restaurant\FooStorage",
 *     "view_builder" = "Drupal\Core\Entity\EntityViewBuilder",
 *     "list_builder" = "Drupal\lei_restaurant\FooListBuilder",
 *     "views_data" = "Drupal\lei_restaurant\Entity\FooViewsData",
 *     "translation" = "Drupal\lei_restaurant\FooTranslationHandler",
 *
 *     "form" = {
 *       "default" = "Drupal\lei_restaurant\Form\FooForm",
 *       "add" = "Drupal\lei_restaurant\Form\FooForm",
 *       "edit" = "Drupal\lei_restaurant\Form\FooForm",
 *       "delete" = "Drupal\lei_restaurant\Form\FooDeleteForm",
 *     },
 *     "access" = "Drupal\lei_restaurant\FooAccessControlHandler",
 *     "route_provider" = {
 *       "html" = "Drupal\lei_restaurant\FooHtmlRouteProvider",
 *     },
 *   },
 *   base_table = "foo",
 ...
 *   translatable = TRUE,
 *   admin_permission = "administer foo entities",
 *   entity_keys = {
 *     "id" = "id",
 *     "revision" = "vid",
 *     "label" = "name",
...
class Foo extends RevisionableContentEntityBase implements FooInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['user_id'] = BaseFieldDefinition::create('entity_reference')
      ...
      ->setDescription(t('The user ID of author of the Foo entity.'))
    ...
    $fields['name'] = BaseFieldDefinition::create('string')
      ->setLabel(t('Name'))
      ->setDescription(t('The name of the Foo entity.'))
      ->setRevisionable(TRUE)
      ->setSettings([
        'max_length' => 50,
        'text_processing' => 0,
    ...
    $fields['status'] = BaseFieldDefinition::create('boolean')
      ...
      ->setDescription(t('A boolean indicating whether the Foo is published.'))
      ->setRevisionable(TRUE)
